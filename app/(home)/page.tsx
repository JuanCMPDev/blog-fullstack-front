...
const mockPosts = [
  {
    ...
    excerpt: 'Un vistazo a los fundamentos de la programación y cómo empezar tu viaje en el mundo del desarrollo de software.',
    votes: 10,
    comments: 5,
  ...
  },
  {
    ...
    excerpt: 'Explorando árboles y grafos en profundidad: cómo estas estructuras de datos complejas pueden optimizar tus algoritmos.',
    votes: 15,
    comments: 8,
    image: '/placeholder-post-image.jpeg',
